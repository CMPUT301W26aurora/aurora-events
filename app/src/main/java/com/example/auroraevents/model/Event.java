...
public class Event {
    ...
    private Map<String, Timestamp> deadlines;
    ...
    public void setDeadlines(Map<String, Timestamp>deadlines){this.deadlines=deadlines;}
    public Map<String, Timestamp> getDeadlines() {return this.deadlines;}
    ...
    /**
     * Generates a qr code from event id
