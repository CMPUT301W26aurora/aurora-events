 ...
 */
public class OrganizerNotificationArrayAdapter
        extends RecyclerView.Adapter<OrganizerNotificationArrayAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.recipient.setText("Sent to: " +
                (n.getRecipientName() != null ? n.getRecipientName() : "Unknown"));
        holder.timestamp.setText(
                n.getTimestamp() != null ? DATE_FMT.format(n.getTimestamp()) : "");
    }
